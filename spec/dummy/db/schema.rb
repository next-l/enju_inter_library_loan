...
ActiveRecord::Schema.define(version: 20161114083857) do
  ...
  create_table "inter_library_loan_transitions", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.boolean  "most_recent"
    t.index ["inter_library_loan_id"], name: "index_inter_library_loan_transitions_on_inter_library_loan_id", using: :btree
    t.index ["sort_key", "inter_library_loan_id"], name: "index_inter_library_loan_transitions_on_sort_key_and_loan_id", unique: true, using: :btree
  end
  ...
  create_table "inter_library_loans", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["borrowing_library_id"], name: "index_inter_library_loans_on_borrowing_library_id", using: :btree
    t.index ["item_id"], name: "index_inter_library_loans_on_item_id", using: :btree
  end
